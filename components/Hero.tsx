        ...
        <section className="pt-32 pb-16 lg:pt-40 relative overflow-hidden flex flex-col items-center justify-center bg-white z-20">
            <div className="w-full relative z-10">
                ...
                >
                    ...
                    <div className="relative overflow-hidden group w-full aspect-[4/3] md:aspect-video flex items-center justify-center">
                        ...
                        <motion.h1
                            ...
                            className="relative z-10 w-full text-4xl sm:text-6xl md:text-7xl lg:text-[10rem] font-black leading-[0.85] py-4 tracking-[-0.05em] text-black bg-white mix-blend-screen font-anton uppercase select-none"
                        >
