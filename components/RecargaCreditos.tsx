        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    >
                        <div className="bg-zinc-900/70 backdrop-blur-3xl border border-white/10 rounded-3xl overflow-hidden shadow-[0_0_80px_rgba(0,0,0,0.8)] relative">
                            {/* Close */}
                            <button
                                onClick={onClose}
                            ...
                            <div className="p-8 relative z-10">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-2">
                                    ...
                                    {/* OPCIÓN 1: Básica */}
                                    <div className="group relative bg-zinc-800/50 border border-white/10 p-7 rounded-2xl hover:border-slate-500/30 transition-all flex flex-col items-center text-center backdrop-blur-xl overflow-hidden shadow-[inset_0_0_20px_rgba(255,255,255,0.02)]">
                                        <div className="w-14 h-14 bg-white/5 rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">
                                            <Sparkles className="w-7 h-7 text-slate-400 group-hover:text-white transition-colors" />
                                        </div>
                                        ...
                                        <a href="https://checkout.wompi.co/l/RECARGA_BASICA_PLACEHOLDER" target="_blank" className="w-full bg-white text-black py-3.5 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-slate-100 transition-all shadow-xl shadow-black/20 flex items-center justify-center gap-2 group/btn">
                                            <CreditCard className="w-4 h-4 group-hover/btn:scale-110 transition-transform" /> Comprar 15 Créditos
                                        </a>
                                    </div>

                                    {/* OPCIÓN 2: PRO */}
                                    <div className="group relative bg-gradient-to-b from-blue-600/[0.1] to-indigo-600/[0.05] border-2 border-blue-500/40 p-7 rounded-2xl shadow-[0_0_40px_rgba(59,130,246,0.1)] flex flex-col items-center text-center overflow-hidden hover:border-blue-400/60 transition-all backdrop-blur-md">
                                        {/* Badge Mejor Valor */}
