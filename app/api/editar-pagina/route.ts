...
- ¡CRÍTICO Y VITAL! SI AGREGAS O MODIFICAS IMÁGENES, OBLIGATORIAMENTE usa la URL: https://image.pollinations.ai/prompt/[descripción-en-ingles-detallada-y-fotorrealista-estilo-nano-banana-2]?width=[ancho]&height=[alto]&nologo=true . REEMPLAZA CADA ESPACIO EXCLUSIVAMENTE CON GUIONES MEDIOS ('-'). NO DEJES ESPACIOS EN BLANCO EN LA URL PUES SE ROMPERÁ.
